...
import { e as renderElement, g as generateCspDigest, s as spreadAttributes, u as unescapeHTML, b as renderTemplate, f as removeBase, i as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, h as createHeadAndContent, c as renderComponent } from './entrypoint_D3Dmxail.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_e-E3HnHN.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_L5LABFEf.mjs').then(n => n._);
